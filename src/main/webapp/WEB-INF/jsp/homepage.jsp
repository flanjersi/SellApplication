...
<div class="container">
    ...
    <div class="row">
        <div id="carouselNewProductExampleIndicators" class="carousel slide" data-ride="carousel">
            <ol class="carousel-indicators">
                <li data-target="#carouselNewProductExampleIndicators" data-slide-to="0" class="active"></li>
                <c:forEach var="num" begin="1" end="${fn:length(lastProducts) - 1}">
                    <li data-target="#carouselNewProductExampleIndicators" data-slide-to="${num}" ></li>
                </c:forEach>
            </ol>
            <div class="carousel-inner">
                <c:forEach items="${lastProducts}" var="lastProduct" varStatus="status">
                <c:choose>
                ...
                <a class="carousel-control-prev" href="#carouselNewProductExampleIndicators" role="button" data-slide="prev">
                    <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                    <span class="sr-only">Previous</span>
                </a>
                <a class="carousel-control-next" href="#carouselNewProductExampleIndicators" role="button" data-slide="next">
        ...
        <div class="row">
            ...
            <div class="col-lg-3">
                ...
                <div class="list-group">
                    ...
                    <button id="btnAddProduct" type="button" class="mt-2 btn btn-success"
                            data-toggle="modal" data-target="#myModal">
                        <i class="fa fa-plus" aria-hidden="true"></i> Add Product
                    </button>

                    <button id="btnUploadFile" type="button" class="mt-2 btn btn-success"
                            data-toggle="modal" data-target="#modalUpload">
                        <i class="fa fa-plus" aria-hidden="true"></i> Upload File
                    </button>
                </div>
            ...
            <div class="col-lg-9">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form id="addproductform"
                                      action="${pageContext.request.contextPath}/add" method="POST"> <!-- Choisir l'url adéquate et la méthode http voulue -->
                                    <div class="form-group">
                                        <label for="titleinput">Title:</label>
                                        <input type="text" class="form-control" id="titleinput" name="title"></input>
                                    </div>
                                    <div class="form-group">
                                        <label for="descriptioninput">Description:</label>
                                        <input type="text" class="form-control" id="descriptioninput" name="description"></input>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" id="priceInput" name="price"></input>
                                    </div>
                ...
                <div id="modalUpload" class="modal fade" role="dialog">
                    <div class="modal-dialog">
                        ...
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title">Choose your file</h5>
                                <button type="button" class="close" data-dismiss="modal">&times;</button>
                            </div>
                            <div class="modal-body">
                                <form id="uploadFileProduct"
                                      action="${pageContext.request.contextPath}/uploadFile" method="POST"> <!-- Choisir l'url adéquate et la méthode http voulue -->
                                    <div class="form-group">
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="button" class="btn btn-primary"
                                        data-dismiss="modal"
                                        onclick="document.getElementById('uploadFileProduct').submit(); return false;">Upload</button>
                            </div>
                        </div>
